...
public class GelidDirtBlock extends SpreadableBlock implements Fertilizable {
    public GelidDirtBlock(Settings settings) {
        super(settings);
    }
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        BlockState blockState = FrozenUpBlocks.FROZEN_GRASS.getDefaultState();
