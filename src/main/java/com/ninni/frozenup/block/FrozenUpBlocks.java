...
public class FrozenUpBlocks {
    public static final Block CHILLOO_FEATHER_BLOCK = register("chilloo_feather_block", new Block(FabricBlockSettings.create().strength(0.1f).mapColor(DyeColor.WHITE).sounds(FrozenUpBlockSoundGroups.CHILLOO_FEATHER_BLOCK)));
    ...
    public static final Block CHILLOO_FEATHER_LAMP = register("chilloo_feather_lamp", new FeatherLampBlock(FabricBlockSettings.create().mapColor(DyeColor.WHITE).strength(0.3F).sounds(FrozenUpBlockSoundGroups.CHILLOO_FEATHER_BLOCK).luminance(createLightLevelFromLitBlockState())));

    public static final Block TRUFFLE_CAKE = register("truffle_cake", new TruffleCakeBlock(FabricBlockSettings.create().mapColor(DyeColor.BROWN).strength(0.5F).sounds(BlockSoundGroup.WOOL).pistonBehavior(PistonBehavior.DESTROY)));
    ...
    public static final Block COMPACTED_SNOW_BRICKS = register("compacted_snow_bricks", new Block(AbstractBlock.Settings.copy(Blocks.SNOW_BLOCK).requiresTool().strength(0.4F).sounds(FrozenUpBlockSoundGroups.COMPACTED_SNOW)));
