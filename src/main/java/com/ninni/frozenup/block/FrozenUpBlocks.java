...
public class FrozenUpBlocks {
    public static final Block CHILLOO_FEATHER_BLOCK = register("chilloo_feather_block", new Block(FabricBlockSettings.create().strength(0.1f).sounds(FrozenUpBlockSoundGroups.CHILLOO_FEATHER_BLOCK)));
    ...
    public static final Block CHILLOO_FEATHER_LAMP = register("chilloo_feather_lamp", new FeatherLampBlock(FabricBlockSettings.create().strength(0.3F).sounds(FrozenUpBlockSoundGroups.CHILLOO_FEATHER_BLOCK).luminance(createLightLevelFromLitBlockState())));

    public static final Block TRUFFLE_CAKE = register("truffle_cake", new TruffleCakeBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.WOOL)));

    public static final Block CUT_ICE = register("cut_ice", new Block(FabricBlockSettings.copyOf(Blocks.PACKED_ICE)));
    public static final Block CUT_ICE_STAIRS = register("cut_ice_stairs", new StairsBlock(CUT_ICE.getDefaultState(), FabricBlockSettings.copyOf(CUT_ICE)));
    ...
    public static final Block CUT_ICE_CUBE_STAIRS = register("cut_ice_cube_stairs", new StairsBlock(CUT_ICE_CUBES.getDefaultState(), FabricBlockSettings.copyOf(CUT_ICE_CUBES)));
    ...
    public static final Block EMPTY_MUG = register("empty_mug", new MugBlock(FabricBlockSettings.create().sounds(BlockSoundGroup.STONE).nonOpaque()));
    ...
    public static final Block COMPACTED_SNOW_BRICKS = register("compacted_snow_bricks", new Block(AbstractBlock.Settings.create().mapColor(MapColor.WHITE).requiresTool().strength(0.4F).sounds(FrozenUpBlockSoundGroups.COMPACTED_SNOW)));
