...
public class FrozenUpEntities {
    ...
    public static final RegistryObject<EntityType<ReindeerEntity>> REINDEER = ENTITY_TYPE.register("reindeer", () -> EntityType.Builder.of(ReindeerEntity::new, MobCategory.CREATURE).sized(1.0F, 1.2F).clientTrackingRange(8).build(new ResourceLocation(FrozenUp.MOD_ID, "reindeer").toString()));
