...
public class MilkMugItem extends Item {
   public MilkMugItem(Settings builder) {
      super(builder);
   }
   ...
   public ItemStack finishUsing(ItemStack stack, World worldIn, LivingEntity entityLiving) {
	      ...
	      if (!worldIn.isClient) entityLiving.removeStatusEffect(StatusEffects.HERO_OF_THE_VILLAGE);
	      if (!worldIn.isClient) entityLiving.removeStatusEffect(StatusEffects.HUNGER);
	      if (!worldIn.isClient) entityLiving.removeStatusEffect(StatusEffects.INSTANT_DAMAGE);
	      if (!worldIn.isClient) entityLiving.removeStatusEffect(StatusEffects.INSTANT_HEALTH);
	      ...
	      if (!worldIn.isClient) entityLiving.removeStatusEffect(StatusEffects.REGENERATION);
	      ...
	      if (!worldIn.isClient) entityLiving.removeStatusEffect(StatusEffects.SPEED);
